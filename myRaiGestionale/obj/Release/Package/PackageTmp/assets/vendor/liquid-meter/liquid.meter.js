...
(function($) {
	...
	LiquidMeter.prototype = {
		...
		init: function(el, options) {
            ...
            svg.setAttribute('viewBox', this.options.attributeScale);
		...
		draw: function() {
            ...
            this.label = paper.text(this.options.paperText1, this.options.paperText2, [this.options.percentuale, '%']);
			this.label.attr({
