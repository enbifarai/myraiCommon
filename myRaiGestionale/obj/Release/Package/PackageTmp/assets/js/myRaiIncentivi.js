...
function ShowIncentivato(id_dipendente, openForAnpal, nomeModale) {
    if (nomeModale == undefined || nomeModale == null) {
        nomeModale = 'modal-dettaglioInc';
    }
    RaiOpenAsyncModal(nomeModale, "/Cessazione/GetDettaglioIncentivato", { idDip: id_dipendente, openForAnpal: openForAnpal }, null, 'POST');
}
function ShowIncentivatoReview(id_dipendente, openForAnpal, nomeModale) {
    if (nomeModale == undefined || nomeModale == null) {
        nomeModale = 'modal-pratica-review';
    }
    RaiOpenAsyncModal(nomeModale, "/Cessazione/GetDettaglioIncentivatoReview", { idDip: id_dipendente, openForAnpal: openForAnpal }, null, 'POST');
}

function RefreshIncentivato(id_dipendente) {
    var obj = id_dipendente;
    var openForArapl = $('#openForAnpal').val();
    $("#incContent").html(' ');
    $.ajax({
        url: "/Cessazione/GetDettaglioIncentivato",
        type: "POST",
        data: { idDip: obj, openForAnpal: openForArapl },
        async: false,
        success: function (data) {
...
function CercaAnpal() {
    ...
    $("#ElencoAnpalExt").addClass("rai-loader");

    var actionElenco = $('#ElencoAnpal').attr('data-action');
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (soloScrittura) {
                //$('#SummaryFiltri').hide();
                $('#ElencoAnpal').html(data);
                $("#ElencoAnpalExt").removeClass("rai-loader");
            }
            else {
                $.ajax({
                    url: "/Cessazione/GetStringaFiltri",
...
function AggiungiNotaPratica(idDipendente) {
    swal({
...
function IncModificaNotaPratica(idDipendente, idNota) {
    ...
    swal({
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "html",
            data: { idNota: idNota, notaPratica: nota },
            success: function (data) {
                switch (data) {
                    case "OK":
...
function SubmitAvviaPratica(prosegui, stato, oper, showAlert) {
    event.preventDefault();
        ...
        swal({
            ...
            if (prosegui && !stato) {
                ...
                swal({
                    ...
                    var nota = result;
                    InternalSubmitAvviaPratica(prosegui, stato, nota, showAlert, oper);
                })
            } else {
                InternalSubmitAvviaPratica(prosegui, stato, '', showAlert, oper);
            }
...
function InternalSubmitAvviaPratica(prosegui, stato, nota, showSuccess, oper) {
...
function IncModalAnpal() {
    RaiOpenAsyncModal('modal-anpal', '/Cessazione/Modal_Anpal', null, UpdateAnpal, 'POST');
}
function UpdateAnpal() {
    CercaAnpal();
}
// #endregion
...
function GestUpdateRif(input) {
    if (parseFloat($(input).attr('data-rif')) != parseFloat($(input).val())) {
...
function GestRefreshDipData(idDip, reloadData) {
    ...
    $.ajax({
        ...
        type: "POST",
        data: { idDip: idDip, reloadData: reloadData },
        success: function (data) {
...
function GestUpdatePratica(idDip) {
    ...
    CallUpdateProvvPratica(idDip, idProvv, dtaDec, catRich, piano, isGestExt, idTemplate, codMansione, statoLettera);
}

function CallUpdateProvvPratica(idDip, idProvv, dtaDec, catRich, piano, isGestExt, idTemplate, codMansione, statoLettera) {
    var list = new Array();
    ...
    $.ajax({
        ...
        type: "POST",
        contentType: 'application/json',
        data: JSON.stringify({ idDip: idDip, idProv: idProvv, dataDec: dtaDec, customProv: list, catRich: catRich, piano: piano, isGestExt: isGestExt, idTemplate: idTemplate, codMansione: codMansione, statoLettera: statoLettera }),
        success: function (data) {
            switch (data) {
                case "update":
