...
namespace myRaiCommonModel.Gestionale
{
    ...
    public class GestioneIncaricoModel
    {
        ...
        public bool FromAnagrafica { get; set; }
        public string CodSezioneFromAnagrafica { get; set; }
    }
    ...
    public class IncarichiTreeModel
    {
        ...
        public bool FromAnagrafica { get; set; }
        public string FromAnagraficaRiportaA { get; set; }

        public void GetModel(myRaiDataTalentia.TalentiaEntities db, string dataStruttura=null, AbilDir abilDir=null)
        {                       
            ...
            if (abilDir != null && abilDir.HasFilter)
            {
                if (abilDir.DirezioniIncluse.Any())
                    this.AlberoItems = this.AlberoItems.Where(x => abilDir.DirezioniIncluse.Contains(x.servizio)).ToList();

                if (abilDir.DirezioniEscluse.Any())
                    this.AlberoItems = this.AlberoItems.Where(x => !abilDir.DirezioniEscluse.Contains(x.servizio)).ToList();
            }
        }
        ...
        public void GetDettaglio(string idsezione,string dataStruttura, myRaiDataTalentia.TalentiaEntities db)
        {
            ...
            if (sezione != null)
            {
                ...
                {
                    this.Dettaglio.CodServizio = sezione.servizio.Trim();
            ...
            //var test = db.XR_STR_TINCARICO.Where(x => x.id_sezione == id).ToList();
    ...
    public class OggettoPerSessioneOrganizzazione
    {
        public DateTime Data { get; set; }
        public IncarichiTreeModel Obj { get; set; }
    }

    public class AggiornaSessioneResponse
    {
        public DateTime Data { get; set; }
