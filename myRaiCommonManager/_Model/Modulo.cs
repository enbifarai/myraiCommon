...
namespace myRaiCommonModel
{
    ...
    public enum ModuloSmart2020SelectionEnum
    {
        ...
        [Description("lavoratore 'fragile' ai sensi del Decreto interministeriale del 4 febbraio 2022. Esercizio del diritto a rendere la prestazione nella modalita' del lavoro agile")]
        Scelta40 = 400,

        [Description("di essere in possesso di una certificazione, rilasciata dal medico di medicina generale, attestante il ricorrere di una delle patologie e condizioni previste dal Decreto 4 febbraio 2022;")]
        Scelta50 = 500,

        [Description("di essere stato riconosciuto disabile in condizione di gravita' ai sensi dell'art. 3, comma 3, L. n. 104/1992;")]
        Scelta60 = 600,

        [Description("di essere lavoratore immunodepresso o con esiti di patologie oncologiche in possesso di una certificazione di rischiosita' rilasciata dai competenti organi medico-legali delle ASL in data anteriore all'entrata in vigore del Decreto del 4 febbraio 2022.")]
        Scelta70 = 700,

        [Description("di essere lavoratore in possesso di una certificazione, rilasciata dai competenti servizi organi medico – legali delle ASL, attestante una condizione di rischio derivante da immunodepressione o da esiti da patologie oncologiche o dallo svolgimento di relative terapie salvavita.")]
        Scelta80 = 800,

        [Description("lavoratore che assiste soggetto in condizione di grave disabilita'.")]
        Scelta90 = 900,

        [Description("di essere lavoratore in possesso di una certificazione, rilasciata dai competenti servizi medico – legali delle ASL, attestante una condizione di rischio derivante da immunodepressione o da esiti da patologie oncologiche o dallo svolgimento di relative terapie salvavita.")]
        Scelta1000 = 1000,
    ...
    public class IncentivazioneFile
    {
        ...
        public string MatricolaApprv { get; set; }
