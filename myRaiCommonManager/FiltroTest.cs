    ...
    public class FiltroTest
    {
        public List<string> EccezioniDaRimuovere(dayResponse R, List<string> Eccezioni)
        {
            ...
            foreach ( var ecc in Eccezioni )
            {
                if ( ecc == "AR20" )
                {
                    ...
                    if (
                        Utente.TipoDipendente() == "G"
                         ...
                         &&
                             (R.eccezioni.Any(x => x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW" || x.cod.Trim().StartsWith("SE") || x.cod.Trim().StartsWith("IS"))
                               ||
                ...
                if ( ecc == "AT30" )
                {
                    if (
                          ...
                          && R.eccezioni != null
                          &&
                             (R.eccezioni.Any(x => x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW" || x.cod.Trim().StartsWith("SE"))
                               ||
                             ( R.timbrature != null && R.timbrature.Length > 0 ) )
                          )
                    {
            ...
            && !LD.Contains( R.giornata.data )
                ...
                if ( ecc == "LN16" )
                {
                    bool FuoriSede = R.eccezioni.Any(x => (x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW") || x.cod.Trim().StartsWith("SE") || x.cod.Trim().StartsWith("IS"));
                ...
                if ( ecc == "LN20" )
                {
                        ...
                        )
                    {
                        ...
                        {
                            if (R.eccezioni.Any(x => (x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW") || x.cod.Trim().StartsWith("SE") || x.cod.Trim().StartsWith("IS")))
                            {
                                //ok ti spetta
                            }
                            else
...
&& !R.eccezioni.Any( x => x.cod.Trim( ).StartsWith( "MF" ) || x.cod.Trim( ).StartsWith( "MR" ) )
                        &&
                           (R.eccezioni.Any(x => (x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW") || x.cod.Trim() == "SE")
                             ||
                           ( R.timbrature != null && R.timbrature.Length > 0 ) )
                        )
                    {
                        ...
                        else if (R.eccezioni.Any(x => (x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW") || x.cod.Trim().StartsWith("SE")))
                        {
                            //ok ti spetta
                        }
                        else
            ...
            && R.eccezioni.Any( x => x.cod.Trim( ).StartsWith( "MNS" ) )
                ...
                if ( ecc == "ORV" )
                {
                    ...
                    else
                    {
                        ...
                        var trasferta = TrasferteManager.GetTrasferte(R.giornata.data, Utente.Matricola());
                        var db = new myRaiData.digiGappEntities();
                    ...
                    if (R.eccezioni != null && R.eccezioni.Any(x => x.cod.Trim() == "SW"))
    {
                ...
                if ( ecc == "TN30" )
                {
                        ...
                        )
                    {
                        ...
                        if ( uscIniz >= 1470 )
                        {
                            if (R.eccezioni.Any(x => (x.cod.Trim().StartsWith("FS") || x.cod.Trim() == "SW") || x.cod.Trim().StartsWith("SE")))
                            {
                                //ok ti spetta
                            }
                            else
                ...
                if ( ecc == "TN35" )
                {
                        ...
                        )
                    {
                        ...
                        {
                            if (R.eccezioni.Any(x => x.cod.Trim() == "FS" || x.cod.Trim() == "SW" || x.cod.Trim() == "SE" || x.cod.Trim() == "FSM" || x.cod.Trim() == "SEM"))
                            {
                                //ok ti spetta
                            }
                            else
                            {
                                if ( R.timbrature != null && R.timbrature.Count( ) > 0 )
                                {
                                    if ( R.timbrature.Last( ).uscita != null )
                                    {
                                        ...
                                        if (R.eccezioni.Any(x => x.cod.Trim() == "FS" || x.cod.Trim() == "SW" || x.cod.Trim() == "FSM") || ((timbIniz <= 390)))
                                        {
                                            //ok ti spetta
                                        }
                                        else
