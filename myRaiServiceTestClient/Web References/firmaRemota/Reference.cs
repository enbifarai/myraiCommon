...
namespace myRaiServiceTestClient.firmaRemota {
    using System;
    ...
    public partial class remoteSignature : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public remoteSignature() {
            this.Url = global::myRaiServiceTestClient.Properties.Settings.Default.myRaiServiceTestClient_firmaRemota_remoteSignature;
        ...
        public SignatureDocumentInfo documentPdfInfo([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] signedDocument, bool verifySignatures, bool extractFields, bool extractX509) {
        ...
        /// <remarks/>
        public void documentPdfInfoAsync(byte[] signedDocument, bool verifySignatures, bool extractFields, bool extractX509) {
            this.documentPdfInfoAsync(signedDocument, verifySignatures, extractFields, extractX509, null);
        }
        
        /// <remarks/>
        public void documentPdfInfoAsync(byte[] signedDocument, bool verifySignatures, bool extractFields, bool extractX509, object userState) {
        ...
        public SignatureDocumentInfo documentXadesInfo([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] signedDocument, [System.Xml.Serialization.XmlElementAttribute("verifySignatures")] bool verifySignatures1, bool extractContent, bool extractX509) {
        ...
        /// <remarks/>
        public void documentXadesInfoAsync(byte[] signedDocument, bool verifySignatures1, bool extractContent, bool extractX509) {
            this.documentXadesInfoAsync(signedDocument, verifySignatures1, extractContent, extractX509, null);
        }
        
        /// <remarks/>
        public void documentXadesInfoAsync(byte[] signedDocument, bool verifySignatures1, bool extractContent, bool extractX509, object userState) {
