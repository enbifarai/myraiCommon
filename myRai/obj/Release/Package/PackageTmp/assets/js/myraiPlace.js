...
function ShowGestisciCampagna(ope, cam) {
    RaiOpenAsyncModal('modal-campagna', "/CampagnaAbbonamenti/ShowGestisciCampagna", { idCampagna: cam }, function () {
        UIRai.initHelpers('datetimepicker');
        if (ope == "v") {
...
function ShowGestisciOmaggio(ope, omag) {
    RaiOpenAsyncModal("modal-omaggio", "/Omaggi/ShowGestisciOmaggio", { idOmaggio: omag }, function () {
        UIRai.initHelpers('datetimepicker');
...
function GestisciOmaggio() {
    ...
    $('#btnConfermaOmaggio').addClass('disable');
        ...
        success: function (data) {
            switch (data) {
                case "ok":
                    ...
                    break;
                default:
                    $('#btnConfermaOmaggio').removeClass('disable');
