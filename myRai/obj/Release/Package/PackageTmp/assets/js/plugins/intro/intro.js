  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      skipTooltipButton.className = "text-primary text-bold pointer introjs-custom";
      ...
      lineLayer.innerHTML = "<div style=\"width:200px;border-bottom:solid 1px #eee;margin:auto;margin-top:20px; margin-bottom:20px\"> </div>";
      buttonsLayer.appendChild(lineLayer);

      //in order to prevent displaying next/previous button always
      if (this._introItems.length > 1) {
          // aggiunta bottone "Indietro"
          buttonsLayer.appendChild(prevTooltipButton);
          // aggiunta bottone "Avanti"
          buttonsLayer.appendChild(nextTooltipButton);
      }

        // aggiunta bottone "Esci"
