...
namespace myRaiCommonDatacontrollers.DataControllers
{
	...
	public class NoteRichiesteDataController
	{
		...
		/// <returns></returns>
		public MyRai_Note_Richieste InserisciNotaRichiesta ( string matricola, string nomeUtente, string nota, DateTime giornata, string sedeGapp, string destinatario = "Segreteria" )
		{
			...
			try
			{
                ...
                {
                    InviaMailNotaDallaSegreteria( destinatario , nota , giornata );
                }
            }
			catch ( Exception ex )
			{
        ...
        private void InviaMailNotaDallaSegreteria ( string matricola, string messaggio, DateTime data )
        {
            string body = "";
            string oggetto = "";
            string dest = "";
