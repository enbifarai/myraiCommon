...
function ValModalValutazioneUpdateStatus() {
    ...
    let radioElem = $('#table-Valutazione div[data-val-question][data-val-typequestion="int"][data-val-optional="false"] input[type="radio"]:checked').length;
    let editElem = $('#table-Valutazione div[data-val-question][data-val-typequestion="edit"][data-val-optional="false"] textarea').filter(function () { return $(this).val() != ''; }).length;
    let comboElem = $('#table-Valutazione div[data-val-question][data-val-typequestion="combo"][data-val-optional="false"] select').filter(function () { return $(this).val() != ''; }).length;
    let valuedElements = radioElem + editElem + comboElem;
