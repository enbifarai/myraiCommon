...
namespace Multiplo.Helpers
{
    public class Output
    {
        private readonly string LogDirPath = System.Configuration.ConfigurationManager.AppSettings["LogOutput"] ?? Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logs");
